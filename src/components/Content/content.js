...
Desarrollar el Análisis de agua, alimentos en general, para cada uno de nuestros clientes ofreciendo un resultado veraz y oportuno de alta calidad, a través de un servicio amable, puntual. Obteniendo la satisfacción de nuestros clientes y el crecimiento de nuestra empresa.

### Visión

Ser el Laboratorio Autorizado a nivel regional y nacional, contar con la entera satisfacción de nuestros clientes, entregar oportunamente los resultados de ensayo y ofrecer una mejor calidad de vida a todo colaborador y ejecutivo que labora en nuestra empresa.

### Filosofía

Nuestro compromiso hacia nuestros clientes, así como para con nuestro equipo de trabajo, está basado en la mejora continua, teniendo como prioridad la excelencia en nuestros resultados de ensayo y en los servicios que brindamos.
...
El objetivo principal de Laboratorio de Análisis y Control Especializado, S.A. de CV [LACESA], es realizar Análisis microbiológicos, fisicoquímicos y toxicológicos de alimentos, agua potable, agua potable embasada, aguas residuales industriales, aguas residuales tratadas, aguas naturales, de proyectos construcciones de sistemas de tratamiento de aguas, unidades de verificación, así como el muestreo de sus productos que sean para control interno de calidad.

### Presentación de LACESA


Laboratorio de Análisis y Control Especializado, S.A. de C.V. (LACESA), está ubicado actualmente en calle Sabancuy #22 región 98 Fracc. Ah Kimpech Cancún, Q. Roo. Inició sus actividades en marzo de 1974 en la Cd. de México, con el nombre de Laboratorio de Control Especializado SA de CV, siendo nuestro fundador el Dr. Ricardo Olmedo Salido quién es egresado del Instituto Politécnico Nacional.

Nuestro objetivo es efectuar análisis Físico-Químicos y Microbiológicos de materias primas, productos acabados, alimentos, agua para la Industria y Empresas que requieren control de calidad o cumplir con la normatividad. LACESA cuenta con personal especializado y de probada experiencia, ofreciendo a todos nuestros clientes el mejor servicio con soluciones integrales y de alta calidad, proporcionando la mejor asesoría sobre las alternativas técnicas, económicas y legales en nuestra materia.`
},
{
...
3. Hacerle llegar alguna cotización solicitada
4. Elaboración de Informes de Resultados
5. Emisión de facturas
6. Notificarle sobre nuevas pruebas certificadas
7. Comunicarle sobre los cambios de nuestro marco analítico
...
Con terceros, proveedores de servicios, para atender las necesidades del titular y nuestros clientes con la calidad y oportunidad ofrecida.
Esto siempre de acuerdo a lo estrictamente señalado en el Capítulo V artículos 36 y 37 de la Ley Federal de Protección de Datos Personales en Posesión de Particulares.

LACESA, transfiere únicamente Datos Personales y Datos Patrimoniales con personas físicas o morales que colaboren en la prestación de los servicios para los cuales somos contratados. Los Datos Personales Sensibles que nos sean transferidos son manejados de forma responsable y confidencialmente. 

En LACESA, protegemos y salvaguardamos sus datos personales para evitar daño, pérdida, destrucción, robo, extravió, alteración, así como el tratamiento no autorizado de sus Datos Personales. Los datos son protegidos de forma administrativa, técnica y física para evitar pérdidas, usos incorrectos o accesos no autorizados, publicación, modificación o destrucción de los datos personales que nos haya proporcionado.
...
Correo electrónico: privacidad@lacesa.com
Teléfono: (01-998)  8 43 - 79 - 59
Dirección: Calle Sabancuy Mza.21 Lte.22, colonia Ah Kim Pech Reg. 98, Ciudad Cancún, Municipio Benito Juárez, Q.roo, c.p. 77537`
}
]
